...
from fine_tune_combined import load_data_combined
...
def run_test(checkpoint_path, data_path, mask_dir, save_path):
    """ Seeding """
    seeding(42)
    ...
    """ Test dataset """
    (train_x, train_y), (test_x, test_y) = load_data_combined(data_path, mask_dir)
...
if __name__ == "__main__":
    ...
    print("=== Pancreas ===")
    run_test(
        f"{files_dir}/p/checkpoint_finetune.pth",
        data_path, "p_masks",
        f"results/ps_combined/p"
    )

    print("\n=== Splenic Vein ===")
    run_test(
        f"{files_dir}/vs/checkpoint_finetune.pth",
        data_path, "vs_masks",
        f"results/ps_combined/vs"
    )
